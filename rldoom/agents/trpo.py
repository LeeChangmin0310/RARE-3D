...
class TRPOAgent(Agent):
    """
    Simplified TRPO-style agent:
    - Same backbone as PPO
    - Uses KL penalty in the objective instead of exact constrained optimization.
    """
    ...
    def __init__(self, obs_shape, num_actions, cfg, device):
        ...
        self.trpo_epochs = cfg.trpo_epochs
    ...
    def update(self) -> Dict[str, float]:
        ...
        for _ in range(self.trpo_epochs):
            ...
            for start in range(0, total_steps, batch_size):
                ...
                policy_loss = -(ratio * mb_advantages).mean() + self.kl_coef * kl
